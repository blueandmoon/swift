...
class ShapeLayerAnimationController: UIViewController, CAAnimationDelegate {
    ...
    private func setUpView() {
        ...
        //  贝塞尔曲线
        let path = UIBezierPath(arcCenter: CGPoint(x: centerX, y: centerY), radius: 80, startAngle: 0, endAngle: CGFloat(M_PI * 2), clockwise: true)
        //  关联layer和贝塞尔曲线
